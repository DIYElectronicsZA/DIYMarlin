...
#define STRING_SPLASH_LINE2 "Printy McPrint Face"//WEBSITE_URL         // will be shown during bootup in line 2
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 505 }
